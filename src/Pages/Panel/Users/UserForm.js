...
export default function UserForm() {
    ...
    const [userPassword, setUserPassword, resetPassword, bindingPassword] =
        useInput("");
    ...
    return (
        <div className="w-full h-full">
            ...
            <div className="flex flex-col gap-5 pt-8 md:pt-10">
                <div className="flex flex-col sm:flex-row lg:flex-row flex-wrap items-center sm:items-start lg:items-start justify-between gap-5">
                    ...
                    <div className="flex sm:flex-row flex-col items-center gap-5 w-full">
                        ...
                        <div className="flex flex-col gap-2 items-start bg-secondary rounded-xl overflow-hidden w-full">
                            <span className="text-xs font-YekanBakh-SemiBold">
                                دسترسی ادمین
                            </span>
