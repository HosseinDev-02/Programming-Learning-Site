...
export default function ArticleForm() {
    ...
    const [articleTime, setArticleTime, resetArticleTime, bindingArticleTime] =
        useInput("");
    const [
        articleDescription,
    ...
    const [articleTeachersMenuShow, setArticleTeachersMenuShow] =
        useState(false);
    ...
    return (
        <div className="w-full h-full">
            ...
            <div className="flex flex-col gap-5 pt-8 md:pt-10">
                <div className="flex flex-col sm:flex-row items-center sm:items-start flex-wrap justify-between gap-5">
                        ...
                        <div className="flex flex-col gap-2 items-start w-full sm:w-1/2">
                            ...
                            <div className="w-full rounded-2xl relative space-y-2">
                                ...
                                >
                                    <ul
                                        onClick={(elem) =>
                                            selectArticleWriter(elem)
                                        }
                                        className="text-xs font-YekanBakh-SemiBold flex flex-col"
                                    >
                                        {writers.map((writer) => (
                                            <li
                                                data-id={writer.user_id}
                                                key={writer.user_id}
                                                className="py-3 px-4 hover:bg-background transition-colors hover:text-title cursor-pointer"
                                            >
                                                {writer.name}
