...
export default function MenuLinkForm() {
    ...
    async function getMainMenuLink() {
        ...
        const mainMenuLink = data.find(
            (link) => link.menulink_id === menuLinkId
        );
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start justify-between gap-5">
                    ...
                    <div className="flex flex-col gap-2 items-start w-full">
                        ...
                        <div className="w-full rounded-2xl relative space-y-2">
                            ...
                            >
                                <ul
                                    onClick={(event) => selectSubmenu(event)}
                                    className="text-xs font-YekanBakh-SemiBold flex flex-col"
                                >
                                    {submenus.map((submenu) => (
                                        <li
                                            data-id={submenu.submenu_id}
