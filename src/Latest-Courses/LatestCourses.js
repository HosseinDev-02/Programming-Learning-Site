                ...
                <div className='grid grid-cols-3 mt-8 gap-5'>
                    <div className=''>
                        ...
                        <div className='bg-gradient-to-b from-white to-zinc-100 mx-5 p-5 rounded-3xl'>
                            ...
                            <h6 className='mt-2'>
                                <a className='hover:text-primary text-title font-semibold transition-colors' href="#">
                        ...
                        <div className='p-5'>
                            ...
                            <div className='flex items-center gap-3 mt-3'>
                                <a className='flex items-center justify-center gap-2 bg-primary rounded-full text-white w-full h-11' href="#">
                                ...
                                <a className='flex items-center justify-center w-11 h-11 rounded-full bg-zinc-100 shrink-0' href="#">
                                    <svg className='w-5 h-5'>
                                        <use href='#heart'></use>
                                    </svg>
                                </a>
