...
export default function SideBar() {
    ...
    return (
        <div style={false ? {right: '0'} : {right: '-256px'}} className='bg-background transition-all fixed -right-64 top-0 bottom-0 min-h-screen z-30 xl:static w-64 rounded-l-2xl divide-y divide-border shrink-0 px-2'>
