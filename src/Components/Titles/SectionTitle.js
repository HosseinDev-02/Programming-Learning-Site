export default function SectionTitle(props) {
    return (
        <div className={`flex items-center gap-2.5 sm:gap-5 shrink-0 ${props.className}`}>
            ...
            <div className='lg:max-w-80'>
                ...
                <span style={{color: props.textColor, fontSize: props.fontSize, lineHeight: props.lineHeight}}
