...
function TableModalAction({id, closeActionModalHandler, removeHandler, showDetailModalHandler, editHandler}) {
    return (
        <div
            ...
            <div className="max-w-64 w-full flex gap-2 flex-col items-center">
                <RoundButton icon='#x-mark-mini' clickEvent={closeActionModalHandler}></RoundButton>
