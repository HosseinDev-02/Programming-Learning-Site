        ...
        count ?
            ...
            icon === '#user' ?
                <a onClick={clickEvent} id={id}
                   className='flex items-center justify-center rounded-full bg-zinc-100 w-10 h-10' href='#'>
                    <svg className='w-5 h-5'>
                        <use href={icon}></use>
                    </svg>
                </a>
                ...
                icon === '#bars-3' ?
                    ...
                    :
                    <a onClick={clickEvent} id={id}
                       className='hidden lg:flex items-center justify-center rounded-full bg-zinc-100 w-10 h-10'
                       href='#'>
                        <svg className='w-5 h-5'>
                            <use href={icon}></use>
                        </svg>
