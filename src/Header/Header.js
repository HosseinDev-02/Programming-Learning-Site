            ...
            <div className='container'>
                <nav className='flex items-center justify-between relative'>
                    <div className='flex items-center gap-8'>
                        ...
                        <ul className='flex items-center gap-5 font-semibold text-sm child-hover:text-title child:transition-colors'>
                            <li className='group/categories'>
                                ...
                                <ul className='invisible opacity-0 group-hover/categories:visible group-hover/categories:opacity-100 absolute top-full bg-white border border-zinc-200 w-56 flex flex-col gap-1 child:leading-5 delay-75 transition-all'>
                    ...
                    <div className='flex items-center gap-5'>
                        <a className='flex items-center justify-center rounded-full bg-zinc-100 w-10 h-10' href="#">
                            <svg className='w-5 h-5'>
                                <use href='#moon'></use>
                            </svg>
                        </a>
                        ...
                        <a className='flex items-center gap-3' href="#">
                            ...
                            <span className='flex flex-col gap-1 items-start text-xs'>
